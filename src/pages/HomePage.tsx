...
const HomePage = () => {
    ...
    return(
      ...
      backgroundColor: "#5C5C60", 
        ...
        <Grid container sx={{display: "flex", flexDirection: { xs: "column", md: "row" }, justifyContent: "space-between", alignItems: "center", overflow: "hidden"}}>
          <Grid item xs={12} md={6} sx={{ display: "flex", justifyContent: "center", mb: { xs: 2, md: 0 } }}>
         { photoData &&  <img
